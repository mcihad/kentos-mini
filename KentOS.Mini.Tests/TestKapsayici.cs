...
public static class TestKapsayici
{
    ...
    private sealed class SessizGelenKutusu : IGelenKutusuServisi
    {
        ...
        public Task<KentOS.Mini.Application.Dto.V2.Ortak.SayfaliSonuc<
            KentOS.Mini.Application.Dto.V2.IsTakip.GelenKutusuDto>> ListeAsync(
            KentOS.Mini.Application.Dto.V2.Ortak.SayfaIstegi istek,
            KentOS.Mini.Application.Enums.GelenKutusuDurumu? durum,
        ...
        public Task<KentOS.Mini.Application.Dto.V2.IsTakip.GelenKutusuDto> KabulAsync(
            long id, KentOS.Mini.Application.Dto.V2.IsTakip.GelenKutusuKabulDto istek,
            CancellationToken iptal = default) => throw new NotSupportedException();

        public Task<KentOS.Mini.Application.Dto.V2.IsTakip.GelenKutusuDto> ReddetAsync(
            long id, string gerekce, CancellationToken iptal = default) =>
            throw new NotSupportedException();

        public Task<KentOS.Mini.Application.Dto.V2.IsTakip.GelenKutusuDto> OkunduAsync(
