...
using KentOS.Kalem.Web.Middleware;
using FluentValidation;
using KentOS.Kalem.Web.Services.V2;
using KentOS.Kalem.Web.Validation.V2;
...
KentOS.Kalem.Web.Filters.HataTurleri.Kur(
...
KentOS.Kalem.Web.Mapping.MapsterConfig.Register(mapsterConfig);
...
builder.Services.AddScoped<KentOS.Kalem.Web.Filters.FormPortaliFiltresi>();
...
KentOS.Kalem.Web.Services.V2.KartTasarimlari.FontlariKaydet(
